...
public class TWDAlgorithm
{
	...
	public TWDAlgorithm(int n, int m,
	...
	{
		String file_path = "C:/Users/naruto/Desktop/Algorithms results/Algorithms results (overlap)/real-world networks/";
		...
		double b = 0.47;
		double e = 0.5;
		TWDAlgorithm twd = new TWDAlgorithm(data_reader.n, data_reader.m,
