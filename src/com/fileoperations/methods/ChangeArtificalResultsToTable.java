...
public class ChangeArtificalResultsToTable
{
	public String source_file;
	public String target_file;

	public ChangeArtificalResultsToTable()
	{
		this.source_file = new String();
		this.target_file = new String();
	}

	public ChangeArtificalResultsToTable(String source_file, String target_file)
	{
	...
	{
		ChangeArtificalResultsToTable results_to_matlab = new ChangeArtificalResultsToTable();
